...
export const SEED_COMMUNITIES = [
  { name: "DSA Grinders — 6AM Batch", category: "Study", tags: ["Study", "Coding & Projects"], desc: "Daily LeetCode + GFG problems before 8AM lectures. No excuses, no snoozing.", members: 42, lastActive: 4 },
  { name: "Sem 3 Notes Exchange", category: "Study", tags: ["Study"], desc: "Scanned notes, previous year papers, and last-minute doubt-clearing before exams.", members: 118, lastActive: 22 },
  { name: "Library 2nd Floor Regulars", category: "Study", tags: ["Study"], desc: "Quiet study squad that camps the window seats every evening.", members: 9, lastActive: 2 },
  { name: "Sunday Football League", category: "Sports", tags: ["Sports", "Networking & Social"], desc: "5-a-side on the back ground, every Sunday 6PM. Bring your own jersey.", members: 63, lastActive: 15 },
  { name: "Badminton Court Bookings", category: "Sports", tags: ["Sports"], desc: "Coordinate slots for the indoor court so we stop double-booking.", members: 31, lastActive: 40 },
  { name: "Cricket Nets Practice", category: "Sports", tags: ["Sports"], desc: "Evening net practice, all skill levels, extra kit available.", members: 27, lastActive: 95 },
  { name: "5AM Running Club", category: "Fitness", tags: ["Fitness"], desc: "Morning loop before the sun's up. Slow runners very welcome.", members: 21, lastActive: 8 },
  { name: "Hostel Gym Buddies", category: "Fitness", tags: ["Fitness"], desc: "Spotting partners and split routines for the hostel gym.", members: 34, lastActive: 30 },
  { name: "Yoga on the Lawn", category: "Fitness", tags: ["Fitness"], desc: "Sunset yoga sessions, mats shared, all levels.", members: 12, lastActive: 210 },
  { name: "Open Source Saturdays", category: "Coding & Projects", tags: ["Coding & Projects"], desc: "Weekly hack session — pick an issue, pair up, ship a PR.", members: 47, lastActive: 6 },
  { name: "CTF Practice Squad", category: "Coding & Projects", tags: ["Coding & Projects"], desc: "Weekend CTFs, writeups, and forensics challenge breakdowns.", members: 19, lastActive: 12 },
  { name: "Local App Builders", category: "Coding & Projects", tags: ["Coding & Projects", "Networking & Social"], desc: "People building real products together — demo day every month.", members: 25, lastActive: 3 },
  { name: "2BHK Near Gate 3", category: "Roommates", tags: ["Roommates"], desc: "Looking for one more roommate for next semester, rent split 3 ways.", members: 4, lastActive: 55 },
  { name: "PG Shifting Help", category: "Roommates", tags: ["Roommates"], desc: "Coordinate shifting, shared autos, and furniture hand-me-downs.", members: 16, lastActive: 140 },
  { name: "Weekend Hill Station Trips", category: "Travel", tags: ["Travel", "Networking & Social"], desc: "Planning short 2-day trips, splitting cabs and stays.", members: 38, lastActive: 70 },
  { name: "Backpacking on a Budget", category: "Travel", tags: ["Travel"], desc: "Tips, group bookings and cheap hostel finds for the next long weekend.", members: 22, lastActive: 300 },
  { name: "Valorant Ranked Squad", category: "Gaming", tags: ["Gaming"], desc: "Looking for a 5-stack, Diamond+ preferred but not required.", members: 29, lastActive: 5 },
  { name: "Board Game Nights", category: "Gaming", tags: ["Gaming", "Networking & Social"], desc: "Catan, Codenames, and chai every Friday in the common room.", members: 33, lastActive: 18 },
  { name: "Newcomers Meetup Circle", category: "Networking & Social", tags: ["Networking & Social"], desc: "Casual hangouts for anyone new around here to make friends.", members: 51, lastActive: 9 },
  { name: "Local Founders Circle", category: "Networking & Social", tags: ["Networking & Social", "Coding & Projects"], desc: "Peer support for people building something on the side.", members: 14, lastActive: 26 },
  { name: "Sunday Jam Session", category: "Music", tags: ["Music"], desc: "Bring an instrument or just your voice — open jam every Sunday evening.", members: 24, lastActive: 11 },
  { name: "Vinyl & Coffee Club", category: "Music", tags: ["Music", "Networking & Social"], desc: "Record swaps, playlist swaps, and way too much coffee.", members: 17, lastActive: 45 },
  { name: "Weeknight Dinner Club", category: "Cooking", tags: ["Cooking"], desc: "Rotating potluck — someone hosts, everyone brings a dish.", members: 36, lastActive: 7 },
  { name: "Sourdough Starters Anonymous", category: "Cooking", tags: ["Cooking"], desc: "Sharing starters, troubleshooting crumb, and swapping loaves.", members: 13, lastActive: 60 },
  { name: "Sketchbook Sundays", category: "Art & Design", tags: ["Art & Design"], desc: "Bring a sketchbook, sit, draw together, no pressure.", members: 20, lastActive: 14 },
  { name: "Street Art & Murals Walk", category: "Art & Design", tags: ["Art & Design", "Travel"], desc: "Monthly walking tour of the best murals around town.", members: 15, lastActive: 88 },
  { name: "Friday Movie Nights", category: "Movies & TV", tags: ["Movies & TV"], desc: "Cult classics, one pick each week, popcorn provided.", members: 41, lastActive: 5 },
  { name: "Watch Party — New Releases", category: "Movies & TV", tags: ["Movies & TV", "Networking & Social"], desc: "Coordinating group watch parties for the latest drops.", members: 28, lastActive: 20 },
  { name: "Monthly Book Club", category: "Books & Reading", tags: ["Books & Reading"], desc: "One book a month, one evening of discussion and snacks.", members: 32, lastActive: 30 },
  { name: "Secondhand Bookswap", category: "Books & Reading", tags: ["Books & Reading"], desc: "Bring a book, take a book — no money involved.", members: 19, lastActive: 100 },
  { name: "Golden Hour Photo Walks", category: "Photography", tags: ["Photography"], desc: "Weekly walk chasing the best light, all skill levels welcome.", members: 26, lastActive: 9 },
  { name: "Street Photography Crew", category: "Photography", tags: ["Photography", "Art & Design"], desc: "Candid, unposed, real life — feedback swaps every weekend.", members: 18, lastActive: 35 },
  { name: "Dog Park Regulars", category: "Pets & Animals", tags: ["Pets & Animals"], desc: "Coordinating meetup times at the park so the dogs have friends too.", members: 30, lastActive: 6 },
  { name: "Foster & Rescue Network", category: "Pets & Animals", tags: ["Pets & Animals", "Networking & Social"], desc: "Connecting fosters, adopters, and vet recommendations nearby.", members: 12, lastActive: 50 },
  { name: "Weekend Cleanup Crew", category: "Volunteering", tags: ["Volunteering"], desc: "Park and beach cleanups, gloves and bags provided.", members: 22, lastActive: 16 },
  { name: "Tutoring for Local Kids", category: "Volunteering", tags: ["Volunteering", "Study"], desc: "A couple hours a week helping neighborhood kids with homework.", members: 16, lastActive: 40 },
